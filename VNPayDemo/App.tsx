...
import { NativeEventEmitter, SafeAreaView, StyleSheet, Text, TouchableOpacity, } from 'react-native';
...
const App = () => {
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: 'black', justifyContent: 'center', alignItems: 'center' }}>
            <Text style={{ fontSize: 22, color: 'white' }}>abced</Text>
            <TouchableOpacity style={{ paddingHorizontal: 24, paddingVertical: 10, backgroundColor: 'blue600', borderRadius: 10 }}
                onPress={() => {
